            ...
            VStack(spacing: 20) {
                ...
                Button {
                    if !name.isEmpty && !venue.isEmpty && !tasks.isEmpty && !dayOfWeek.isEmpty, let category = selectedFilter {
                            viewModel.editStat(workout, name: name, venue: venue, tasks: tasks, dayOfWeek: dayOfWeek, startTime: startTime, endTime: endTime, category: category)
                ...
                .onAppear {
                    ...
                    selectedFilter = workout.category
...
#Preview {
    EditWorkoutUIView(viewModel: WorkoutViewModel(), workout: Workout(name: "Strength training", venue: "Main hall", tasks: "Working on throws", dayOfWeek: "Sunday", startTime: Date(), endTime: Date(), category: "Tactical training"))
}
